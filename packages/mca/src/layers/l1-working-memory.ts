...
export class L1WorkingMemory {
  ...
  async getStatistics(): Promise<any> {
    ...
    return {
      ...
      average_turns_per_session: this.sessions.size > 0 ? totalTurns / this.sessions.size : 0,
      average_tokens_per_session: this.sessions.size > 0 ? totalTokens / this.sessions.size : 0
    };
  }
}