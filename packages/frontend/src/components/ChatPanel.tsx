...
import { ChatMessage, WeightedMemoryFusion, ChatRequest, ChatResponse } from '@cas/types';
  ...
  const handleSendMessage = async (): Promise<void> => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        id: crypto.randomUUID(),
        role: 'assistant',
        content: 'Sorry, I encountered an error processing your message. Please check the backend connection.',
        timestamp: new Date().toISOString()
      };
